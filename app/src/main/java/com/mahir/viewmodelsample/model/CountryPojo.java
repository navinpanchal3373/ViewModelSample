...
package com.mahir.viewmodelsample.model;
...
public class CountryPojo implements Parcelable
{
    ...
    @Expose
    private String cioc;
    public final static Creator<CountryPojo> CREATOR = new Creator<CountryPojo>() {


        @SuppressWarnings({
            "unchecked"
        })
        public CountryPojo createFromParcel(Parcel in) {
            return new CountryPojo(in);
        }

        public CountryPojo[] newArray(int size) {
            return (new CountryPojo[size]);
        }

    }
    ;

    protected CountryPojo(Parcel in) {
